  ...
  return (
    <div className="flex pt-55 items-center min-h-screen flex-col">
      ...
      <div className="flex mb-10 gap-4">
        <Button className="py-6 hover:cursor-pointer hover:scale-102"><Plus /> New Game</Button> 
        <Button className="p-6 hover:cursor-pointer enabled:hover:scale-102" disabled><ArrowRight /> Continue</Button> 
      </div>
